...
const AreyouReady = () => {
  return (
    <div className="pt-10 px-10 max-w-[1440px] mx-auto lg:flex h-[80vh]  md:flex md:items-center md:justify-between w-ful">
      <div className=" flex flex-col items-center justify-center rounded-lg bg-gradient-to-r from-[#88D0D1] to-[#645ADF] w-full h-[50%]">
